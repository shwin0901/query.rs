  ...
  const helpTips = [
    {
      ...
      tips: [
        ...
        {
          title:
            "Search docs by type signature, <a class='dark:text-darkTPrimay dark:visited:text-darkTPrimay' href='https://doc.rust-lang.org/1.79.0/rustdoc/read-documentation/search.html'>full search features</a>",
    ...
    },
    {
      ...
      tips: [
        ...
        {
          title:
            "<a href='/crates' class='dark:visited:text-darkTPrimay'>Add crate</a> to search docs",
    ...
    },
    {
      ...
      tips: [
        ...
        {
          title:
            "Query parameters: <a class='dark:visited:text-darkTPrimay' href='/?q=cell' target='_blank'>?q=cell</a>",
          queries: [],
        },
      ],
    },
...
<div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-8 md:mt-16">
  {#each helpTips as { type, color, darkColor, tips }}
    <div class="rounded border m-2">
      <div
        class="px-4 text-base font-bold {color} {darkColor} dark:text-darkTPrimay"
      >
        {type}
      </div>
      <ul class="px-5 p-2 text-sm list-disc list-outside dark:text-darkTPrimay">
