...
<div class="flex flex-col items-center m-auto w-full">
  ...
  <div class="search-time w-full text-center text-xl dark:text-darkTPrimay">
  ...
  <div id="chart" class="w-full">
    <div class="py-12 w-full mx-auto md:w-[85%]">
      ...
      <div class="search-stats-text p-2">
        <ol class="flex justify-around flex-wrap dark:text-darkTPrimay">
          {#each searchStats as item}
            <div
    ...
    <div class="flex flex-col md:flex-row-reverse md:justify-around pt-16 dark:text-darkTPrimay">
      <div>
        <div>
