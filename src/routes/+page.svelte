...
<div class="cons relative w-full md:w-[80%] mx-[auto] my-[20px]">
  <div
    bind:this={omniboxRender}
    class="omn-container dark:bg-darkBgPrimay dark:text-darkTPrimay"
  >
    <textarea
      class="omn-input dark:bg-darkBgPrimay"
      autocapitalize="off"
      autocomplete="off"
      autocorrect="off"
      maxlength="2048"
...
<Tour bind:this={tour} />
<div class="text-center mt-6 md:mt-10 mx-auto text-wrap dark:text-darkTPrimay">
  Love query.rs?
  <a
    class="dark:text-darkTPrimay dark:visited:text-darkTPrimay"
    href="https://github.com/huhu/query.rs">Star us on GitHub</a
  >, or
  <a class="dark:text-darkTPrimay" href="https://discord.gg/rPWWBqxBhp"
    >Join our Discord!</a
  >
</div>
