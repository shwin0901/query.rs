...
<Toaster />
<div
  class="text-center text-sm max-w-screen-md mx-auto px-4 dark:text-darkTPrimay"
>
  ...
  <a
    ...
    class="dark:visited:text-darkTPrimay">@tokio spawn</a
  >
</div>
<div
...
>
  ...
  <input
    ...
    autofocus
    type="text"
    class="w-full md:w-[400px] h-8 px-2 py-0 rounded border border-solid border-[#f9bb2daa] focus:outline-none dark:bg-darkBgPrimay dark:text-darkTPrimay"
  />
  <span class="btn btn-primary m-4" on:click={addCrate}> Add crate </span>
</div>
<div class="subtext flex justify-between my-4 dark:text-darkTPrimay">
  <span>
  ...
  <span>
    Sort by:
    <select bind:value={orderBy} class="border dark:bg-darkBgPrimay">
